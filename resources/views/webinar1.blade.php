...
<html lang="en">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Registrasi Webinar</h5>
  ...
  <a class="btn btn-warning position-fixed end-0 rounded-pill m-4 px-4" style="z-index: 2;" data-bs-toggle="modal" data-bs-target="#registrasi">Daftar</a>
    ...
    <footer class="p-2 text-white" style="background-color: rgb(89,89,89); margin-bottom: -70px;">
      <div class="row">
        ...
        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="/" target="_blank" >Bioscope</a>
        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            <hr class="bg-white">
            </p>
          </div>
