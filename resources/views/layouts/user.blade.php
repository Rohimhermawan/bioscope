...
<html lang="en">
  ...
  @yield('content')
    ...
    <footer class="p-3 text-white fixed-bottom" style="background-color: rgb(89,89,89);">
      <div class="row">
        ...
        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart" aria-hidden="true"></i> by <a target="_blank" >Bioscope FK Unpad</a>
        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            <hr class="bg-white">
            </p>
          </div>
