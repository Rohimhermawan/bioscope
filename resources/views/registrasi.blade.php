...
<body class="img-fluid" style="background-image: url({{asset('files/authentication/bg-forget-regist.png')}});">
    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block" style="background-image: url({{asset('files/authentication/registrasi.jpeg')}}); background-size:contain;"></div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="post" action="{{url('register')}}">
                                ...
                                <div class="form-group">
                                        <input type="text" class="form-control form-control-user @error('nama') is-invalid @enderror" id="exampleFirstName"
                                ...
                                <div class="form-group">
                                        <input type="password" class="form-control form-control-user @error('password_confirmation') is-invalid @enderror"
                                            id="exampleInputPassword" placeholder="re-Password" name="password_confirmation">
                                </div>
